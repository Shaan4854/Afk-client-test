...
const {
  pathfinder,
  Movements,
  goals: { GoalNear, GoalBlock, GoalFollow }
} = require('mineflayer-pathfinder');
const Vec3 = require('vec3').Vec3;
const readline = require('readline');

// ===========================================================================
// SPAM FILTER (Chunk Error & Warnings Block)
// ===========================================================================
...
function isSpam(args) {
  if (typeof args[0] === 'string' && args[0].includes('Chunk size is')) return true;
  return false;
}

console.log = function(...args) { if (!isSpam(args)) originalLog.apply(console, args); };
console.warn = function(...args) { if (!isSpam(args)) originalWarn.apply(console, args); };
console.error = function(...args) { if (!isSpam(args)) originalError.apply(console, args); };
